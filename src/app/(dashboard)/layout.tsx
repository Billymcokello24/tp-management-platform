    ...
    <SessionProvider>
      ...
      <SidebarProvider>
        ...
        <main className="flex-1 flex flex-col min-h-screen min-w-0 bg-background overflow-x-hidden">
          {/* Top Header Bar */}
          <header className="safe-top h-16 sm:h-20 border-b border-border/60 bg-card flex items-center justify-between px-4 sm:px-6 sticky top-0 z-30 shadow-sm transition-all">
          ...
          <div className="flex-1 p-3 sm:p-6 lg:p-8 overflow-auto">
            <div className="mx-auto w-full md:w-[90%] max-w-[1600px]">
              {children}
            </div>
          </div>
        </main>
